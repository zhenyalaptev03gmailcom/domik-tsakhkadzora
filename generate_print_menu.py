...
SUPPLEMENT_NAME = {
 ...
 "Блинчики с мясом": ("Crepes with Meat", "Մսով նրբաբլիթ"),
...
SUPPLEMENT_DESC = {
 ...
 "Классическая бурата": ("Burrata, tomatoes, greens mix", "Բուռատա, լոլիկ, կանաչիներ"),
 "Цезарь с креветками": ("Shrimp, romaine, Parmesan, croutons, Caesar dressing", "Ծովախեցգետին, պարմեզան, չորահաց, Ցեզար սոուս"),
 ...
 "Сет Домик": ("Chicken and beef kebab, signature barbecue, vegetables", "Հավի և տավարի քյաբաբ, ֆիրմային խորոված, բանջարեղեն"),
...
UI_TR = {
 ...
 "Паста, мясо на углях и авторские сеты": ("Pasta, charcoal-grilled meat and signature sets", "Պաստա, ածխի վրա միս և հեղինակային սեթեր"),
