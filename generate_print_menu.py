...
# ---------- форзац + прощальный разворот в самом конце книги ----------
# Один «пустой» лист-форзац сдвигает финальную страницу на оборот листа
# при двусторонней печати (подобрано под схему печати типографии клиента).
